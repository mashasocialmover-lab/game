...
export const SYNC_INTERVAL = 500; // Интервал синхронизации позиций в мс (увеличено для снижения нагрузки)
export const BATCH_INTERVAL = 300; // Интервал отправки батча событий
export const MAX_BATCH_SIZE = 5; // Максимум событий в батче
